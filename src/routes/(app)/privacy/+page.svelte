...
<p>Telephone does not collect or store any personal information from users. The only information we collect is related
    to the settings of the guilds where the bot is active. This information is only used for the purpose of connecting
    the voice channels and is not shared or used for any other purpose.</p>
